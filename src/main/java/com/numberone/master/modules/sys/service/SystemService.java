...
import com.numberone.master.common.security.Digests;
import com.numberone.master.common.security.shiro.session.SessionDAO;
import com.numberone.master.common.service.BaseService;
import com.numberone.master.common.service.ServiceException;
...
import com.numberone.master.common.web.Servlets;
import com.numberone.master.modules.sys.dao.MenuDao;
import com.numberone.master.modules.sys.dao.RoleDao;
import com.numberone.master.modules.sys.dao.UserDao;
import com.numberone.master.modules.sys.entity.Menu;
...
import com.numberone.master.modules.sys.security.SystemAuthorizingRealm;
import com.numberone.master.modules.sys.utils.LogUtils;
...
public class SystemService extends BaseService implements InitializingBean {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> getMonitorInformation(String name){
		return userDao.getMonitorInformation(name);
	}
	
	/**
	 * 根据id更新表格
	 */
	public Integer updateGrid(Map<String, Object> map) {
		return userDao.updateGrid(map);
	}
	/**
	 * 根据id更新状态
	 */
	...
	public Integer gridDelete(Integer id) {
		return userDao.gridDelete(id);
	}
	 ...
	 * @return
	 */
	public List<Map<String, Object>> queryPhoneList(){
		return userDao.queryPhoneList();
	}
	/**
	 * 删除电话号码
	 * @param id
	 * @return
	 */
	public Integer deletePhoneNum(Integer id) {
		return userDao.deletePhoneNum(id);
	}
	/**
	 * 新增电话号码
	 * @return
	 */
	public Integer insertPhoneNum(String phoneNum) {
		return userDao.insertPhoneNum(phoneNum);
	 ...
	 * @return
	 */
	public List<Map<String, Object>> getAllMonitorInformation(){
		return userDao.getAllMonitorInformation();
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		//sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By https://shop450532966.taobao.com\r\n");
		sb.append("\r\n    欢迎使用熊熊科技管理系统 ");
		sb.append("\r\n======================================================================\r\n");
