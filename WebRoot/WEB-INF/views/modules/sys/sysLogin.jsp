...
<%-- 	<h1 class="form-signin-heading">${fns:getConfig('productName')}</h1> --%>
	...
	<form id="loginForm" class="form-signin" action="${ctx}/login"
		...
		<label for="rememberMe" title="下次不需要再登录"><input
			...
			${rememberMe ? 'checked' : ''} /> 记住我（公共场所慎用）</label>
	...
	<div class="footer">
		...
		<a href="${pageContext.request.contextPath}${fns:getFrontPath()}"></a>
		- Powered By <a href="http://www.kuang-chi.org/index.php"
			target="_blank">深圳光启</a> ${fns:getConfig('version')}
	</div>
