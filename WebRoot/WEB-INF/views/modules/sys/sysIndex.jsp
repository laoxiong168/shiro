	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			...
			<%-- 	<div class="brand"><span id="productName">${fns:getConfig('productName')}</span></div> --%>
				<div class="brand">
				<!-- <span id="productName">深圳-光启222</span> -->
				<img  title='停用'  style='width:25px' src='${pageContext.request.contextPath}/static/images/gq.png'/>
				</div>
				<ul id="userControl" class="nav pull-right">
					...
					<li><a href="" target="_blank" title="主页"><i class="icon-home"></i></a></li>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy;  - Powered By <a href="" target="_blank">深圳光启高等理工研究院</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
