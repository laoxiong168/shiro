...
<li><a class="a-color" href="http://www.baidu.com">模板展示</a></li>
</ul>
...
<section id="wizard">
<div id="rootwizard">
<div class="navbar11" style="margin-top:60px;">
<div class="navbar-inner11" style=" display: block; margin-top: 15px;">
<div class="container11">
...
<div class="form-group">
<label class="col-sm-2 control-label text-right" style="display:inline-block;margin:0px auto;">新&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;郎</label>
<div class="col-sm-3">
...
<img id="imgbackphone" src="http://qjpic.9xian.com/IY2CIdEaVOq6FWhMD0mPs48a5erV010I.jpg?imageMogr2/auto-orient/crop/!532x798a0a0">
</div>
</div>
<div class="col-sm-5">
...
<div id="uploadifive-backphone_upload" class="uploadifive-button" style="height: 30px; line-height: 30px; overflow: hidden; position: relative; text-align: center; width: 100px;">
+选择图片<input type="file" name="backphone_upload" id="backphone_upload" value=""  accept="image/jpeg,image/png;" >
<!-- <input type="file" id='tt' style="font-size: 30px; opacity: 0; position: absolute; right: -3px; top: -3px; z-index: 999;" accept="image/jpeg,image/png;"> -->
</div>
...
<div id="result">
<div class="well" style="overflow:hidden;margin-bottom:0px;padding:10px;clear:both;">
<ul class="house_imglist_sjt ui-sortable">
</ul>
<br class="clear">
<br class="clear">
</div>
...
<div class="col-sm-2">
<div class="preview-img">
<img id="imgwx_mainpic" src="http://qjpic.9xian.com/IY2CIdEaVOq6FWhMD0mPs48a5erV010I.jpg?imageMogr2/auto-orient/crop/!532x798a0a0">
</div>
</div>
<div class="col-sm-5">
...
<div id="modellist">
<div class="modal fade momo-hy" style="top: 0px;right: 0px;margin:0 auto;" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
<div class="modal_wrapper" style=" margin:0 auto;">
<div class="modal-dialog modal-sm" style="width: 450px;z-index: 1045; margin:0 auto;">
...
<div class="modal fade momo-pic-jiancai" style="top: 0px;right: 0px;width: 550px; z-index: 1045;margin:0 auto;" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
<div class="modal_wrapper">
<div class="modal-dialog modal-sm" style="width: 550px;    z-index: 1045;">
<div class="modal-content login-all-type">
<div class="modal-header">
...
<iframe id="jiancaiiframe" src="http://www.baidu.com" style="width: 100%; height: 495px; border: 0px;"></iframe>
</div>
</div>
</div>
</div>
...
$('#file_upload_sjt').uploadifive({
	...
	'onUploadComplete' :	function( fileObj, response, data)	{
	    ...
	    if(response.status=="200"){
			var s = '<li class="pic-'+response.piccode+'" desc="" >'+
					'<div class="file_cancel">'+
					'<a title="删除图片" class="a-del" onclick="delpic('+response.piccode+');" href="javascript:;"></a>'+
					'<a title="裁剪图片" class="a-edit" onclick="editpic('+response.piccode+');" href="javascript:;"></a>'+
					'<a title="编辑图片" class="a-oen" onclick="setpicdesc('+response.piccode+');" href="javascript:;"></a>'+
					'</div>'+
					 '<select class="picselectt1" onchange="setpictx(this.value,'+response.piccode+')">'+
	                      ...
	                      '</select>'+
					'<div class="ppimg" style="border: 1px dashed #BFBFBF;width: 120px;height: 90px;background: url('+response.minpath+') no-repeat;background-size: auto 100%;background-position: center;"></div>'+
					'<input type="hidden" name="picssort[]" value="'+response.piccode+'" />'+
				'</li>';
...
/*改造后的上传图片*/
$("#ttdfdsfdsf").change(function(obj) {
...
alert("出发函数");
    ...
    var Qiniu_upload = function(f, token, key, li_progress) {
        ...
        xhr.onreadystatechange = function(response) {
            //alert("接收到的controller传来得到值："+xhr.responseText); 
            ...
            var upload_ok_url="http://static.yidianzixun.com/beauty/imgs/i_000cfwku.jpg";
            $("#photo_url_"+li_progress).val(upload_ok_url);
            $("#img_preview_"+li_progress).attr("src", upload_ok_url);
        };
