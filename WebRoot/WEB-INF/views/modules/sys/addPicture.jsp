...
End Function
    ...
    <link href="${ctxStatic}/mycss/WdatePicker.css" rel="stylesheet" type="text/css">
...
<!-- <form action="springUpload?ac=info&amp;do=edit_three&amp;id=CD1508745399023694X6k" method="post" class="form-horizontal form-validate" novalidate="novalidate" enctype="multipart/form-data"> -->
  <form action="generateHTML" method="post"  enctype="multipart/form-data">  
...
<input name="file_url" class="fileprew" id="file_url" type="file" accept="image/*" multiple="multiple">
</div>
...
var Qiniu_UploadUrl = "springUpload";
var img_num = 0;
...
<div id="fallr-overlay"></div><div id="_my97DP" style="position: absolute; top: -1970px; left: -1970px;">
<iframe style="width: 192px; height: 234px;" src="./卡美美_files/My97DatePicker.html" frameborder="0" border="0" scrolling="no"></iframe></div>




    <script type="text/javascript" src="${ctxStatic}/myjs/inside.js"></script>
    <script type="text/javascript" src="${ctxStatic}/myjs/WdatePicker.js"></script>
    ...
    <script type="text/javascript" async="" src="${ctxStatic}/myjs/vds.js"></script>
    ...
    <script type="text/javascript" src="${ctxStatic}/myjs/jquery_mb_miniPlayer.js"></script>
</body></html>