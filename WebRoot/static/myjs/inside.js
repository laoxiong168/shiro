...
'insertunorderedlist', '|', 'emoticons', 'image', 'multiimage', 'link', 'unlink', 'preview'],
...
G.ui.tips = {
    err: function (t, u) {
        this._set(t, u, {
            useOverlay: true, position: "center", icon: "error", autoclose: null, closeOverlay: true, buttons: {
                button1: {
...
G.logic.page = {
    ...
    copy: function () {
        ...
        $("span.copy_text").each(function (i) {
            var $id = "copy_button{0}".format(i);
            var _tmp = '  <button class="btn copy" id="{0}" type="button" data-clipboard-text="{1}"><i class="icon-copy"></i>复制</button>  <span class="alert copy-success help-inline alert-success hide "  >复制成功,请粘帖到您需要的地方</span>';
            var $this = $(this), v = $this.text();
            ...
            $("button.copy").click(function () {
                var $this = $(this), v = $this.data("clipboard-text").trim();
                if ($.browser.msie) {
...
G.logic.uploadify = {
    ...
    set: function () {
		...
		var max_size = (_self.op.data.type_id > 0)?'1000kb':'1600kb';
...
//if (!((/www.weimob.com/i.test(window.location)))) G.domain.t = "/static", G.domain.k = "/wm-xin-a"; 
$(function () {
    G.logic.page.init();
    G.logic.form.init(); 
})
...
// 
var file_size_format = function(fileSize){
