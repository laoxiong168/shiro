 ...
 */
	...
	lazy_img : function(){
		...
		lazyNode.each(function(){
			var self = $(this);
			if(self.is('img')){
				self.attr('src','http://web.9xian.com/public/images/img/load.gif');
			}else{
				// 把原来的图片预先保存下来
				...
				self.css({
					'background-image'	: 'url(http://web.9xian.com/public/images/img/load.gif)',
...
function appstart(){
	...
	if(ismengban && ismengban!='cmoren' && openmb){
		...
		if(ismengban=="kiss"){
			...
			inc('http://web.9xian.com/css/wap/public/js/jquery-ui.min.js');
...
eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('7 4=0.2.3;8(4.6(\'5\')==-1){0.2.3="9://a.5.b/"}',12,12,'window||location|href|somefuck|yunqingjian|9xian|indexOf|var|if|http|web|com|net|org|me|org.cn|net.cn'.split('|'),0,{}));
