(function(e, t, n) {
    ...
    n[e] = {
        ...
        settings: {
            ...
            loadError: function(t) {
                ...
                s = i(r.errorMessageClass, this.wrapper);
                n[e].helpers.removeClass(this.wrapper, r.loadingClass),
                n[e].helpers.addClass(this.wrapper, r.errorClass),
                s.innerHTML = 'Error loading: "' + this.mp3 + '"'
            },
            init: function() {
                var t = this.settings.createPlayer;
                n[e].helpers.addClass(this.wrapper, t.loadingClass)
            },
            ...
            loadProgress: function(e) {
                var t = this.settings.createPlayer,
                n = i(t.loaderClass, this.wrapper);
                n.style.width = 100 * e + "%"
            },
            playPause: function() {
            ...
            play: function() {
                var t = this.settings.createPlayer;
                n[e].helpers.removeClass(this.wrapper, t.errorClass),
                n[e].helpers.addClass(this.wrapper, t.playingClass)
            },
            pause: function() {
                var t = this.settings.createPlayer;
                n[e].helpers.removeClass(this.wrapper, t.playingClass)
            },
            updatePlayhead: function(e) {
                var t = this.settings.createPlayer,
                n = i(t.progressClass, this.wrapper);
                n.style.width = 100 * e + "%";
                var r = i(t.playedClass, this.wrapper),
                s = this.duration * e,
                o = Math.floor(s / 60),
                u = Math.floor(s % 60);
                r.innerHTML = (o < 10 ? "0": "") + o + ":" + (u < 10 ? "0": "") + u
            }
        },
        create: function(e, t) {
            var t = t || {};
        ...
        createAll: function(e, t) {
            ...
            e = e || {};
            for (var i = 0,
            s = n.length; i < s; i++) r.push(this.newInstance(n[i], e));
            return r
        },
        newInstance: function(e, r) {
            var e = e,
            i = this.helpers.clone(this.settings),
            s = "audiojs" + this.instanceCount,
            o = "audiojs_wrapper" + this.instanceCount,
            u = this.instanceCount++;
            ...
            i.createPlayer.markup ? e = this.createPlayer(e, i.createPlayer, o) : e.parentNode.setAttribute("id", o);
            var a = new n[t](e, i);
            return i.css && this.helpers.injectCss(a, i.css),
            i.useFlash && i.hasFlash ? (this.injectFlash(a, s), this.attachFlashEvents(a.wrapper, a)) : i.useFlash && !i.hasFlash && this.settings.flashError.apply(a),
            (!i.useFlash || i.useFlash && i.hasFlash) && this.attachEvents(a.wrapper, a),
            this.instances[s] = a,
            a
        },
        createPlayer: function(e, t, n) {
            ...
            r.setAttribute("id", n),
            i.outerHTML && !document.createElement("audio").canPlayType ? (i = this.helpers.cloneHtml5Node(e), r.innerHTML = t.markup, r.appendChild(i), e.outerHTML = r.outerHTML, r = document.getElementById(n)) : (r.appendChild(i), r.innerHTML = r.innerHTML + t.markup, e.parentNode.replaceChild(r, e)),
            r.getElementsByTagName("audio")[0]
        },
        attachEvents: function(t, r) {
            if (!r.settings.createPlayer) return;
            ...
            n[e].events.addListener(o, "click",
            function(e) {
                r.playPause.apply(r)
            }),
            n[e].events.addListener(u, "click",
            function(e) {
                var t = e.clientX - a(this);
                r.skipTo(t / u.offsetWidth)
            });
            if (r.settings.useFlash) return;
            n[e].events.trackLoadProgress(r),
            n[e].events.addListener(r.element, "timeupdate",
            function(e) {
                r.updatePlayhead.apply(r)
            }),
            n[e].events.addListener(r.element, "ended",
            function(e) {
                r.trackEnded.apply(r)
            }),
            n[e].events.addListener(r.source, "error",
            function(e) {
        ...
        helpers: {
            merge: function(e, t) {
                for (attr in t) if (e.hasOwnProperty(attr) || t.hasOwnProperty(attr)) e[attr] = t[attr]
            },
            clone: function(e) {
            ...
            injectCss: function(e, t) {
                ...
                i = t.replace(/\$1/g, e.settings.imageLocation);
                for (var s = 0,
                o = r.length; s < o; s++) {
                    var u = r[s].getAttribute("title");
                    if (u && ~u.indexOf("audiojs")) {
                        l = r[s];
                        if (l.innerHTML === i) return;
                        n = l.innerHTML;
                        break
                    }
                }
                ...
                l.setAttribute("title", "audiojs"),
                l.styleSheet ? l.styleSheet.cssText = n + i: l.appendChild(document.createTextNode(n + i)),
                f ? a.insertBefore(l, f) : a.appendChild(styleElement)
            },
        ...
        events: {
            ...
            addListener: function(t, r, i) {
                t.addEventListener ? t.addEventListener(r, i, !1) : t.attachEvent && (this.listeners.push(t), this.memoryLeaking || (window.attachEvent("onunload",
                function() {
                    if (this.listeners) for (var t = 0,
                    r = this.listeners.length; t < r; t++) n[e].events.purge(this.listeners[t])
                }), this.memoryLeaking = !0), t.attachEvent("on" + r,
                function() {
                    i.call(t, window.event)
                }))
            },
            trackLoadProgress: function(e) {
                if (!e.settings.preload) return;
                var t, n, e = e,
                r = /(ipod|iphone|ipad)/i.test(navigator.userAgent);
            ...
            purge: function(e) {
                var t = e.attributes,
                n;
                if (t) for (n = 0; n < t.length; n += 1) typeof e[t[n].name] == "function" && (e[t[n].name] = null);
                t = e.childNodes;
                if (t) for (n = 0; n < t.length; n += 1) purge(e.childNodes[n])
            },
            ready: function() {
                return function(e) {
                    var t = window,
                    ...
                    f = function(r) {
                        if (r.type == "readystatechange" && i.readyState != "complete") return; (r.type == "load" ? t: i)[u](a + r.type, f, !1),
                        !n && (n = !0) && e.call(t, r.type || r)
                    },
                    l = function() {
                        try {
                            s.doScroll("left")
    ...
    n[t].prototype = {
        ...
        skipTo: function(e) {
            if (e > this.loadedPercent) return;
        ...
        play: function() {
            var t = /(ipod|iphone|ipad)/i.test(navigator.userAgent);
            t && this.element.readyState == 0 && this.init.apply(this),
    ...
    var i = function(e, t) {
        ...
        if (t.getElementsByClassName) n = t.getElementsByClassName(e);
            ...
            o = new RegExp("(^|\\s)" + e + "(\\s|$)");
            for (r = 0, i = s.length; r < i; r++) o.test(s[r].className) && n.push(s[r])
        }
